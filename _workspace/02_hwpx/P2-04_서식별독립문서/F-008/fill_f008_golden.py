"""F-008 템플릿에 비식별 테스트값을 채워 골든 결과를 생성한다.
사용법: python fill_f008_golden.py <템플릿.hwpx> <골든결과.hwpx>
"""
import os
import shutil
import sys
...
def main():
    ...
    work_dir = os.path.join(os.path.dirname(out_path), "_build_tmp_golden_f008")
    ...
    shutil.rmtree(work_dir)
    print(f"PASS: F-008 골든결과 생성 완료 -> {out_path}")
