"""F-041 템플릿(토큰 삽입 완료)에 비식별 테스트값을 채워 골든 결과를 생성한다.
사용법: python fill_f041_golden.py <템플릿.hwpx> <골든결과.hwpx>
"""
import os
import shutil
import sys
...
def main():
    ...
    shutil.rmtree(work_dir)
    print(f"PASS: F-041 골든 결과 생성 완료 -> {out_path} (치환 횟수: {replaced_total})")
